...
int main(int argc, char *argv[])
{
	...
	*/
	...
	game_values.musicvolume			= EZX_volume;
	game_values.soundvolume			= EZX_volume;
	...
	if(fp != NULL)
	{
		...
		if(version[0] == g_iVersion[0] && version[1] == g_iVersion[1] && version[2] == g_iVersion[2] && version[3] == g_iVersion[3])
		{
			...
			game_values.soundvolume = (short)abyte[11]; EZX_set_vol(game_values.soundvolume);
